...
if (preg_match($global_config['check_module'], $module_name)) {
    ...
    if( isset( $array_domain[NV_SERVER_NAME] )){
        if( $module_name != 'data-content' && $module_name != 'photos' && $module_name != 'users' && $module_name != 'regsite' && $module_name != 'reg' && $module_name != 'mkt' ){
            $module_name = 'daily';
            $op = 'main';
        }
    }
