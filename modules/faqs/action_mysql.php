...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_note";
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_answer (
 ...
 cus_name varchar(255) NOT NULL COMMENT 'Ho va ten',
 cus_email varchar(255) NOT NULL,
 addtime int(11) NOT NULL,
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_note (
id MEDIUMINT( 8 ) unsigned NOT NULL AUTO_INCREMENT,
userid MEDIUMINT( 8 ) unsigned NOT NULL ,
sendque MEDIUMINT( 8 ) unsigned NOT NULL ,
anser MEDIUMINT( 8 ) unsigned NOT NULL ,
mostanser MEDIUMINT( 8 ) unsigned NOT NULL ,
choanser MEDIUMINT( 8 ) unsigned NOT NULL ,
mark BIGINT( 20 ) unsigned NOT NULL ,
PRIMARY KEY (id)
)ENGINE=MyISAM";
...
('is_email', '" . $global_config['site_email'] . "'),
('is_cus', '1'),
('is_admin', '1'),
('is_captcha', '3'),
('num_row_list', '10'),
