...
if( $nv_Request->isset_request( 'del', 'post,get' ) )
{
	...
	$qid = $nv_Request->get_int( 'qid', 'post,get', 0 );
...
if( ! empty( $listquestion[$qid] ) )
{
	...
	$xtpl->assign( 'link_module', NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name );
	...
	if( $re->rowCount() )
	{
		...
		while( $row = $re->fetch() )
		{
			...
			$row['link_edit'] = NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=detail&qid=" . $row['qid'] . "&id=" . $row['id'];

			$row['link_duyet'] = NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=detail&qid=" . $row['qid'] . "&duyet=1&id=" . $row['id'];
			$row['link_del'] = NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=detail&qid=" . $row['qid'] . "&del=1&id=" . $row['id'];
			$xtpl->assign( 'ROW', $row );
	...
	if( $nv_Request->get_int( 'id', 'get' ) && ! $nv_Request->get_int( 'duyet', 'get' ) && ! $nv_Request->get_int( 'del', 'get' ) )
	{
