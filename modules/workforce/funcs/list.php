...
if (!empty($q)) {
    $db->where('first_name LIKE :q_first_name OR last_name LIKE :q_last_name OR gender LIKE :q_gender OR birthday LIKE :q_birthday OR phone LIKE :q_phone OR email LIKE :q_email');
}
