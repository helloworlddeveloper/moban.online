...
if (!nv_function_exists('nv_global_bxslider_no_border_center')) {
     ...
     * @return
     */
    function nv_block_config_bxslider_center_no_border_blocks($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_config_bxslider_center_no_border_blocks_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     * @return
     */
    function nv_global_bxslider_no_border_center($block_config)
    {
        ...
        if (file_exists(NV_ROOTDIR . "/themes/" . $global_config['module_theme'] . "/modules/" . $mod_file . "/block.bxslider_no_border_center.tpl")) {
        ...
        $xtpl = new XTemplate('block.bxslider_no_border_center.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
...
if (defined('NV_SYSTEM')) {
    $content = nv_global_bxslider_no_border_center($block_config);
}
