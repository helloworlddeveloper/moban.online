...
if (!nv_function_exists('nv_global_block_showall')) {
     ...
     * @return
     */
    function nv_block_config_block_showall($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_config_block_showall_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     * @return
     */
    function nv_global_block_showall($block_config)
    {
        ...
        if (file_exists(NV_ROOTDIR . "/themes/" . $global_config['module_theme'] . "/modules/" . $mod_file . "/block.block_showall.tpl")) {
        ...
        $xtpl = new XTemplate('block.block_showall.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
...
if (defined('NV_SYSTEM')) {
    $content = nv_global_block_showall($block_config);
}
