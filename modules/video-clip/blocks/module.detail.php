...
$VideoData['download_video'] = NV_BASE_SITEURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . '=down&id=' . $VideoData['id'] . '&token=' . md5( NV_CHECK_SESSION . $VideoData['id'] );
$xtpl->assign('DETAILCONTENT', $VideoData);
if( !empty( $VideoData['internalpath'])){
