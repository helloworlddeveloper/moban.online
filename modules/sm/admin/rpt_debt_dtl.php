...
$page_title = $lang_module['report_debt_detail'];
...
$xtpl = new XTemplate("rpt_debt_dtl.tpl", NV_ROOTDIR . "/themes/" . $global_config['module_theme'] . "/modules/" . $module_file);
...
$sql_where = 'depotid !=0 and order_total != price_payment';
