...
$array_data_num_product = get_order_ordertype2( $user_info['userid'], $date_from, $date_to );
...
if( !empty( $array_data_num_product )){
    foreach ( $array_data_num_product as $producid => $product_info ) {
        ...
        $product_info['numreal'] = isset($product_info['numreal'])? $product_info['numreal'] : 0;
        $product_info['numnecessary'] = $product_info['require'] - $product_info['numreal'];
        $product_info['numnecessary'] = ( $product_info['numnecessary'] < 0 )? '' : $product_info['numnecessary'];
