...
$listorderid = $nv_Request->get_title('BONUS_INDIRECTORDERIDS', 'post,get', '');
$listreturnid = $nv_Request->get_title('BONUS_INDIRECTRETURNIDS', 'post,get', '');

$xtpl = new XTemplate('bonus-indirect.tpl', NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/' . $module_file);
