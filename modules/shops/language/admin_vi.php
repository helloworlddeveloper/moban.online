...
$lang_module['document_returnback'] = 'Chính sách đổi trả';
$lang_module['tabs_content_returnback'] = 'Chính sách đổi trả';
$lang_module['configapi'] = 'Cấu hình API';
$lang_module['save'] = 'Lưu cấu hình';
$lang_module['config'] = 'Cấu hình kết nối';
$lang_module['apikey'] = 'Mã kết nối API';
$lang_module['genpass'] = 'Tạo mật khẩu ngẫu nhiên';
$lang_module['allow_accept'] = 'Chấp nhận kết nối API';
$lang_module['domain_accept'] = 'Domain chấp nhận, Mỗi domain cách bằng dấu phảy.';


//Lang for function customer
$lang_module['customer'] = 'Quản lý khách hàng';
$lang_module['add_customer'] = 'Thêm khách hàng mới';
$lang_module['customer_info'] = 'Thông tin khách hàng';
$lang_module['name'] = 'Tên khách hàng';
...
$lang_module['agency_title'] = 'Bảng giá nhập Đại lý';
...
$lang_module['add_agencycontent'] = 'Thêm thông tin bảng giá nhập hàng';
$lang_module['price_require'] = 'Giá tối thiểu cần nhập hàng';
...
$lang_module['percent_sale'] = '% chiết khấu khi nhập hàng';
$lang_module['error_percent_sale'] = 'Bạn chưa nhập % chiết khấu khi nhập hàng';

$lang_module['content_checkcat'] = 'Chủ đề chính cho sản phẩm';
$lang_module['content_checkcatmsg'] = 'Bạn cần chọn chủ đề chính cho sản phẩm.';
$lang_module['ref_fullname'] = 'Người giới thiệu';
$lang_module['history_shiping_product'] = 'Đang chuyển hàng cho khách';
$lang_module['history_shiped_product'] = 'Khách đã nhận hàng';
$lang_module['order_submit_shiping'] = 'Xác nhận hàng đang chuyển';
$lang_module['order_submit_shiping_ok'] = 'Xác nhận hàng đang chuyển thành công';
$lang_module['order_submit_shiped'] = 'Xác nhận khách đã nhận hàng';
$lang_module['order_submit_shiped_ok'] = 'Xác nhận khách đã nhận hàng thành công';
$lang_module['order_submit_shiping_comfix'] = 'Bạn chắc chắn hàng đã được gửi cho khách hàng?';
$lang_module['order_submit_shiped_comfix'] = 'Bạn chắc chắn khách hàng đã nhận được hàng?';
$lang_module['product_price_sale'] = 'Giá khuyến mãi';