...
function nv_add_customer( $row )
{
    ...
    $data_insert['jobs'] = 0;
    $data_insert['company_name'] = $row['company'];
    $data_insert['description'] = $row['description'];

    $data_insert['ten_nh'] = '';
    $data_insert['stk_nh'] = '';
    $data_insert['tentk_nh'] = '';
    $data_insert['passport'] = '';
    $data_insert['company_mst'] = '';
    $data_insert['company_address'] = '';
    $data_insert['company_phone'] = '';
    $data_insert['company_email'] = '';
    $data_insert['company_gpkd'] = '';
    $data_insert['company_fax'] = '';
...
//edit customer
function nv_edit_customer( $row )
{
    global $db_config, $module_data, $db;

    $row['edit_time'] = NV_CURRENTTIME;
    $stmt = $db->prepare( 'UPDATE ' . $db_config['prefix'] . "_" . $module_data . '_customer SET fullname = :fullname, address = :address, province = :province, phone = :phone, email = :email, company = :company, description = :description, status = :status, edit_time=:edit_time WHERE customer_id=' . $row['customer_id'] );
