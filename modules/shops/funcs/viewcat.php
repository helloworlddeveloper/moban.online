...
if (empty($contents)) {
    ...
    if ($global_array_shops_cat[$catid]['viewcat'] == 'view_home_cat' and $global_array_shops_cat[$catid]['numsubcat'] > 0) {
        ...
        foreach ($array_subcatid as $catid_i) {
            ...
            $where = " (t1.listcatid LIKE '%," . $catid_i . "%' OR t1.listcatid LIKE '%" . $catid_i . ",%' OR t1.listcatid LIKE '%," . $catid_i . ",%' OR t1.catid=" . $catid_i . ")";
      ...
      $where = " (t1.listcatid LIKE '%," . $catid . "%' OR t1.listcatid LIKE '%" . $catid . ",%' OR t1.listcatid LIKE '%," . $catid . ",%' OR t1.catid=" . $catid . ")";
