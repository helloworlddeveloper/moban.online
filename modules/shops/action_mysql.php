...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_customer (
 customer_id mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
 user_id mediumint(8) unsigned NOT NULL,
 fullname varchar(50) NOT NULL,
 address varchar(250) NOT NULL,
 province int(250) NOT NULL,
 phone varchar(50) NOT NULL,
 email varchar(100) NOT NULL,
 company_name varchar(250) NOT NULL,
 facebook varchar(150) NOT NULL,
 jobs smallint(4) unsigned  NOT NULL,
 description text,
 ten_nh varchar(150) NOT NULL,
 stk_nh varchar(50) NOT NULL,
 tentk_nh varchar(150) NOT NULL,
 passport varchar(150) NOT NULL,
 company_mst varchar(50) NOT NULL,
 company_address varchar(150) NOT NULL,
 company_phone varchar(50) NOT NULL,
 company_email varchar(50) NOT NULL,
 company_gpkd varchar(150) NOT NULL,
 company_fax varchar(50) NOT NULL,
 add_time int(11) NOT NULL DEFAULT '0',
 edit_time int(11) NOT NULL DEFAULT '0',
 status tinyint(1) unsigned NOT NULL DEFAULT '0',
 fromby tinyint(1) unsigned NOT NULL DEFAULT '0',
 customer_type tinyint(1) unsigned NOT NULL DEFAULT '0',
 PRIMARY KEY (customer_id),
 UNIQUE KEY name_phone (fullname,phone)
) ENGINE=MyISAM";
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_agency (
 ...
 percent_sale tinyint(1) NOT NULL DEFAULT '0' COMMENT '% chiết khấu',
 description text,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_agency_detail (
...
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'allow_accept', '0')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'domain_accept', '')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'apikey', '')";