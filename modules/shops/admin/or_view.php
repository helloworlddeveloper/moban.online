...
if ($data_content['transaction_status'] == 6) {
    $html_payment = $lang_module['history_shiped_product'];
} elseif ($data_content['transaction_status'] == 5) {
    $html_payment = $lang_module['history_shiping_product'];
} elseif ($data_content['transaction_status'] == 4) {
...
$xtpl->assign('URL_ACTIVE_SHIPING', NV_BASE_ADMINURL . 'index.php?' . NV_NAME_VARIABLE . '=' . $module_name . '&' . NV_OP_VARIABLE . '=active_pay&order_id=' . $order_id . '&action=shiping');
$xtpl->assign('URL_ACTIVE_SHIPED', NV_BASE_ADMINURL . 'index.php?' . NV_NAME_VARIABLE . '=' . $module_name . '&' . NV_OP_VARIABLE . '=active_pay&order_id=' . $order_id . '&action=shiped');
