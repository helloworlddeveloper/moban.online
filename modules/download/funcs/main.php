    ...
    foreach ($list_cats as $value) {
        if (empty($value['parentid'])) {
            ...
            if( $value['numsubcat'] == 0 ){
                ...
                $array_item = array();
                $subcatid = explode(',', $value['subcatid'] );
                foreach ( $subcatid as $catid_i ){
                    $array_item[$catid_i] = array(
                        'id' => $catid_i,
                        'title' => $list_cats[$catid_i]['title'],
                        'introtext' => '',
                        'more_link' => NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name . '&amp;' . NV_OP_VARIABLE . '=' . $list_cats[$catid_i]['alias'],
                        'edit_link' => '',
                        'del_link' => ''
                    );
                }
                ...
                $array_cats[$value['id']]['link'] = NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name . '&amp;' . NV_OP_VARIABLE . '=' . $value['alias'];
                $array_cats[$value['id']]['description'] = $list_cats[$value['id']]['description'];
                $array_cats[$value['id']]['numfile'] = '';
                $array_cats[$value['id']]['viewcat'] = $list_cats[$value['id']]['viewcat'];
                $array_cats[$value['id']]['subcats'] = '';
                $array_cats[$value['id']]['items'] = $array_item;
