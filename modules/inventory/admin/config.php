...
if ($nv_Request->isset_request('submit', 'post')) {
    ...
    $array_config['leader_name'] = $nv_Request->get_title('leader_name', 'post', '');
    $array_config['accountant_name'] = $nv_Request->get_title('accountant_name', 'post', '');
    $array_config['creators_name'] = $nv_Request->get_title('creators_name', 'post', '');
...
if (!empty($module_config[$module_name]['headerfile']) and file_exists(NV_UPLOADS_REAL_DIR . '/' . $module_upload . '/' . $module_config[$module_name]['headerfile'])) {
    $module_config[$module_name]['headerfile'] = NV_BASE_SITEURL . NV_UPLOADS_DIR . '/' . $module_upload . '/' . $module_config[$module_name]['headerfile'];
}
