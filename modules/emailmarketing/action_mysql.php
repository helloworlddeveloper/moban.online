...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_smsrows";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_smsrows_link";
...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_smsqueue";
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_smsrows(
  id int(11) unsigned NOT NULL AUTO_INCREMENT,
  content text NOT NULL,
  customergroup text NOT NULL,
  ...
  sendedlist text NOT NULL COMMENT 'Danh sách khách hàng đã gửi thư',
  errorlist text NOT NULL COMMENT 'Danh sách lỗi',
  totalsmssend mediumint(8) unsigned NOT NULL DEFAULT '0',
  totalsmssuccess mediumint(8) unsigned NOT NULL DEFAULT '0',
  addtime int(11) unsigned NOT NULL,
  typetime tinyint(1) unsigned NOT NULL DEFAULT '0',
  begintime int(11) unsigned NOT NULL DEFAULT '0',
  endtime int(11) unsigned NOT NULL DEFAULT '0',
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_smsrows_link(
  rowsid int(11) unsigned NOT NULL,
  linkmd5 varchar(32) NOT NULL,
  link text NOT NULL,
  countclick mediumint(8) unsigned NOT NULL DEFAULT '0',
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_smsqueue(
  id mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
