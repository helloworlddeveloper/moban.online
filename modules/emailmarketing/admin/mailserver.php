...
if ($nv_Request->isset_request('submit', 'post')) {
    ...
    $row['smtp_password'] = nv_base64_encode($crypt->aes_encrypt($row['smtp_password']));
...
$row['smtp_password'] = !empty($row['smtp_password']) ? $crypt->aes_decrypt(nv_base64_decode($row['smtp_password'])) : '';
