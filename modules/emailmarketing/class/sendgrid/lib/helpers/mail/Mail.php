...
class OpenTracking implements \JsonSerializable
{
    ...
    private $enable, $substitution_tag;
...
class SubscriptionTracking implements \JsonSerializable
{
    ...
    private $enable, $text, $html, $substitution_tag;
...
class Ganalytics implements \JsonSerializable
{
    ...
    private $enable, $utm_source, $utm_medium, $utm_term, $utm_content, $utm_campaign;
...
class TrackingSettings implements \JsonSerializable
{
    ...
    private $click_tracking, $open_tracking, $subscription_tracking, $ganalytics;
...
class SpamCheck implements \JsonSerializable
{
    ...
    private $enable, $threshold, $post_to_url;
...
class MailSettings implements \JsonSerializable
{
    ...
    private $bcc, $bypass_list_management, $footer, $sandbox_mode, $spam_check;
...
class ASM implements \JsonSerializable
{
    ...
    private $group_id, $groups_to_display;
...
class Personalization implements \JsonSerializable
{
    ...
    private $tos, $ccs, $bccs, $subject, $headers, $substitutions, $custom_args, $send_at;
...
class Mail implements \JsonSerializable
{
    ...
    public $from, $personalization, $subject, $contents, $attachments, $template_id, $sections, $headers, $categories, $custom_args, $send_at, $batch_id, $asm, $ip_pool_name, $mail_settings, $tracking_settings, $reply_to;
