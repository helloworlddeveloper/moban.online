...
class Client
{
     ...
     *
     * @param string $host
     *            the base url (e.g. https://api.sendgrid.com)
     * @param array $headers
     *            global request headers
     * @param string $version
     *            api version (configurable)
     * @param array $path
     *            holds the segments of the url path
     */
     ...
     *            an array of all the query parameters
     *            
     * @return string
     */
     ...
     *
     * @param string $name
     *            name of the dynamic method call or HTTP verb
     * @param array $args
