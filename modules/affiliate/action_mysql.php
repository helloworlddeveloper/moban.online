...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $module_data . "_bonuses;";
...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_productregister;";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $module_data . "_agency;";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $module_data . "_possiton;";
...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $module_data . "_jobs;";
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang  . "_" . $module_data . "_scanuser_config;";
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_users (
  ...
  precode varchar(15) NOT NULL COMMENT 'Tiền tố mã nhân viên',
  code varchar(15) NOT NULL COMMENT 'Mã nhân viên',
  mobile varchar(50) NOT NULL COMMENT 'SĐT',
  peopleid varchar(50) NOT NULL COMMENT 'So CMND',
  salary_day float NOT NULL DEFAULT '0' COMMENT 'Lương theo ngày',
  benefit float NOT NULL DEFAULT '0' COMMENT 'tiền phụ cấp',
  datatext text,
  weight smallint(5) unsigned NOT NULL DEFAULT '0',
  sort smallint(5) NOT NULL DEFAULT '0',
  lev smallint(5) NOT NULL DEFAULT '0',
  possitonid smallint(5) NOT NULL DEFAULT '0' COMMENT 'ID vị trí nhân viên',
  agencyid smallint(5) NOT NULL DEFAULT '0' COMMENT 'ID agency hoặc ID vị trí nhân viên chỉ chọn 1 trong 2',
  istype tinyint(4) NULL DEFAULT '0' COMMENT '0 =NPP, 1 Hieu thuoc',
  numsubcat smallint(5) NOT NULL DEFAULT '0',
  subcatid text DEFAULT '',
  listparentid text DEFAULT '',
  ...
  haveorder tinyint(4) unsigned NULL DEFAULT '0',
  shareholder tinyint(4) unsigned NULL DEFAULT '0',
  deviceid varchar(250) NOT NULL COMMENT '',
  jobid INT UNSIGNED NOT NULL DEFAULT '0',
  pendingdelete INT UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Thời gian chờ xóa',
  ishidden tinyint(4) unsigned NULL DEFAULT '0' COMMENT '0 không ẩn, 1 ẩn trên sơ đồ cây',
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_product (
 ...
 module_name varchar(250) DEFAULT '',
 status tinyint(1) unsigned NOT NULL DEFAULT '0',
 PRIMARY KEY (id)
) ENGINE=MyISAM";

//bang san pham dang ky ban cua ctv
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_productregister (
 userid mediumint(5) NOT NULL,
 product_allow text NOT NULL DEFAULT '',
 product_pedding text NOT NULL DEFAULT '',
 product_noallow text NOT NULL DEFAULT '',
 status tinyint(1) unsigned NOT NULL DEFAULT '0',
 PRIMARY KEY (userid)
) ENGINE=MyISAM";
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_chamcong (
 ...
 teacherid smallint(4) unsigned NOT NULL COMMENT 'Mã NV',
 datetime int(10) unsigned NOT NULL COMMENT 'Ngày chấm công',
 checkin varchar(5) NULL COMMENT 'chấm công vào',
 checkout varchar(5) NULL COMMENT 'chấm công ra',
 infocheck varchar(250) DEFAULT '' COMMENT 'Chi tiết các lần chấm công',
 numcheck tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT 'số lần chấm công',
 ngaycong FLOAT(1) unsigned NOT NULL DEFAULT '0' COMMENT 'Tính công là: 0.5, 1, hay 1.5 công',
 dimuon tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 = không đi muộn,1 = đi muộn',
 dimuoncophep tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 = không phép,1 = có phép',
 vesom tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 = không về sớm,1 = về sớm',
 vesomcophep tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 = không phép,1 = có phép',
 note varchar(150) DEFAULT '' COMMENT 'Ghi chú',
 status tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0 = chưa check,1 = đã check',
 admincheck int(11) NOT NULL DEFAULT '0' COMMENT 'Người kiểm tra dữ liệu',
 PRIMARY KEY (id),
 UNIQUE KEY teacherid (teacherid,datetime)
) ENGINE=MyISAM";


$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_agency (
 id mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
 title varchar(250) NOT NULL,
 ...
 price_discount float NOT NULL DEFAULT '0' COMMENT 'tiền chiết khấu',
 percent_discount float NOT NULL DEFAULT '0' COMMENT '% chiết khấu trên tổng đơn',
 description text,
...
//vi tri nhan su
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_possiton (
  id int(11) NOT NULL AUTO_INCREMENT,
  title varchar(250) NOT NULL,
  alias varchar(250) NOT NULL,
  image varchar(250) DEFAULT '',
...
//thuong vuot dinh muc KPI
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_bonuses (
  id int(11) NOT NULL AUTO_INCREMENT,
  title varchar(250) NOT NULL,
...
//nganh nghe
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_jobs (
  id int(11) NOT NULL AUTO_INCREMENT,
  title varchar(250) NOT NULL,
  desctiption text NULL DEFAULT '',
  weight smallint(4) NOT NULL DEFAULT '0',
  status tinyint(4) NOT NULL,
  PRIMARY KEY  (id)
) ENGINE=MyISAM";
...
//Cau hinh quet user + gui sms
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_scanuser_config (
 id int(10) unsigned NOT NULL auto_increment,
 content TEXT NOT NULL,
 hourscan int(10) unsigned NOT NULL default '0' COMMENT 'Giờ sẽ quét user',
 action tinyint(1) unsigned NOT NULL default '0' COMMENT '0=alert, 1=delete',
...
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'precode', 'GM%01s')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'config_postion', '')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'config_fercent_return', '')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'config_fercent_return_agency', '')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'min_payment', '100000')";
...
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'mail_notification', '1')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'register_product_type', '1')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'verify_user', '0')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'scan_user', '0')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'inactive_or_delete', '0')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'sms_register', '1')";

//nhan su
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'nhansu_group_edit_ngaycong', '1')";

//cau hinh di muon, moi khung gio cach 1 dau phay
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'dimuon', '0801-1159,1301-2000')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'vesom', '1000-1159,1600-1729,1930-2059')";

//tinh ca gio lam tron
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'nghigiuaca', '1.5')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'nuaca', '3.2-4')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'motca', '7-8')";

//tru cong ngay di muon
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'max_infringe', '3')";
