...
if ($userid > 0 )
{
    ...
    $array_reponsive["userid"] = $array_data['userid'];
    $array_reponsive["type"] = $type;
    $array_reponsive["infor"] = $type . '-' . $array_data['code'] . '-' . $array_data['fullname'] . '-[' . $array_data['numsubcat'] . ']';
    $array_reponsive["downline"] = array();

    if( $array_data['numsubcat'] > 0){
        $array_reponsive['downline'] = get_sub_nodes_users( $array_data['subcatid'] );
    }
