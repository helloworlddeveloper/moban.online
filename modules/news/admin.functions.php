...
//comment cho bai viet nao do
if ($nv_Request->isset_request('comment', 'get')) {
    $commentid = $nv_Request->get_int('commentid', 'get', 0);
    if( $commentid > 0 ){
        require_once NV_ROOTDIR . '/modules/' . $module_file . '/file_comment.php';
    }
}
