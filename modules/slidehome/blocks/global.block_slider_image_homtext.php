...
if (!nv_function_exists('nv_global_bxslider_image_homtext')) {
     ...
     * @return
     */
    function nv_block_config_bxslider_slider_image_homtext($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_config_bxslider_slider_image_homtext_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     * @return
     */
    function nv_global_bxslider_image_homtext($block_config)
    {
        ...
        if (!defined('BXLIBHOMTE')) {
            define('BXLIBHOMTE', true);
            $xtpl->parse('main.lib');
        }
...
if (defined('NV_SYSTEM')) {
    $content = nv_global_bxslider_image_homtext($block_config);
}
