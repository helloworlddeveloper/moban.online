...
if( ! empty( $q ) )
{
	$db->where( 'reg_full_name LIKE :q_reg_full_name OR reg_email LIKE :q_reg_email OR reg_phone LIKE :q_reg_phone OR reg_address LIKE :q_reg_address OR parent_name LIKE :q_parent_name OR parent_phone LIKE :q_parent_phone' );
}
