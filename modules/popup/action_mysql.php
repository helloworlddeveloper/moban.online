...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_bymodule;";
...
//xay dung hien popup theo tung module - chuyen muc - trang chi tiet

$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_bymodule (
 id mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
 title varchar(255) NOT NULL,
 alias varchar(255) NOT NULL,
 image varchar(255) DEFAULT '',
 description text,
 module_name varchar(55) NULL COMMENT 'Ten module',
 op_name varchar(55) NULL COMMENT 'function name',
 table_show varchar(150) NULL DEFAULT '0' COMMENT 'Bang du lieu check hien thi',
 contentid mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'id bai viet',
 showtype tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0= Click sang link, 1 hform dk tu van, 2 form dk nhan tai lieu',
 link_download varchar(250) NULL DEFAULT '0' COMMENT 'URL download',
 numview mediumint(8) unsigned NOT NULL DEFAULT '0',
 numclick mediumint(8) unsigned NOT NULL DEFAULT '0',
 numdownload mediumint(8) unsigned NOT NULL DEFAULT '0',
 popup_on tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT 'POPUP bật khi nào? 0 theo cau hinh module',
 action_popup varchar(250) NULL DEFAULT '0' COMMENT 'Có tác dụng khi popup_on lớn hơn 0.',
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_" . $module_data . "_data (
 ...
 byid mediumint(8) unsigned NOT NULL,
 idpost mediumint(8) unsigned NOT NULL COMMENT 'ID bai viet day du lieu',
 modulename varchar(50) NOT NULL DEFAULT '' COMMENT '',
 provinceid mediumint(8) unsigned NOT NULL,
 districtid mediumint(8) unsigned NOT NULL,
 student_name varchar(50) NOT NULL COMMENT 'Tên hoc sinh',
 birthday int(11) NOT NULL DEFAULT '0' COMMENT 'Ngày sinh',
 sex tinyint(1) unsigned NOT NULL DEFAULT '0',
 url_reg varchar(255) NOT NULL COMMENT 'Url Đăng ký',
 address varchar(255) NOT NULL COMMENT 'Ðia chi',
 email varchar(100) NOT NULL COMMENT 'Email',
 mobile varchar(20) NOT NULL COMMENT 'SÐT di dong',
 facebook varchar(100) NOT NULL COMMENT 'Facebook',
 add_time int(11) NOT NULL DEFAULT '0',
 edit_time int(11) NOT NULL DEFAULT '0',
 status tinyint(1) unsigned NOT NULL DEFAULT '0',
 PRIMARY KEY (dataid),
 UNIQUE KEY student_name (student_name, mobile)
) ENGINE=MyISAM";
