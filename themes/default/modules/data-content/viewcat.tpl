...
<!-- BEGIN: content -->
<table class="table table-border content_data">
    <thead>
        <tr>
            <th>STT</th>
            <th>Tiêu đề</th>
...
<!-- BEGIN: loop -->
    <tr>
        ...
        <td>
            <h4>
                <a target="_blank" title="{CAT.title}" href="{CAT.link_detail}"><strong>{CAT.title}</strong></a>
            </h4>
        </td>
        <td>
            {CAT.bodytext}
        ...
        <td>
            <a class="btn btn-default" target="_blank" title="{CAT.title}" href="{CAT.link_detail}">Xem chi tiết</a>
        </td>
    </tr>
<!-- END: loop -->
</table>
