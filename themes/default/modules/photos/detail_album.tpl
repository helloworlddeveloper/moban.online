...
<div class="page-header pd10_0 mg0_0_10">
	<h1 class="txt20 txt_bold">
		{ALBUM.name} &nbsp;<a href="{add_more_photo}" class="btn btn-success">{LANG.add_more_photo}</a>
	</h1>
	...
	<div class="col-xs-24 col-sm-12 col-md-{PER_LINE} col-lg-{PER_LINE}">
		<div class="panel panel-default">
			...
			<div class="panel-footer view_detail pd5">
				...
				<span class="text-muted"><em class="fa fa-download"></em>&nbsp;{PHOTO.download}</span>
				<a href="{PHOTO.link_img}" class="pull-right"> <i class="fa fa-picture-o"></i>&nbsp{LANG.view_image}</a>
				<a href="{PHOTO.download_image}" class="pull-right"><i class="fa fa-download"></i>{LANG.download_image}</a>
			</div>
		</div>
	</div>
	<!-- END: loop_img -->
