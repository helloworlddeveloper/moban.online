        ...
        <div class="row">
            <div class="col-xs-24 col-sm-24 col-md-12">
            		...
            		<figure class="article center">
            			<img alt="{DETAIL.titleseo}" src="{DETAIL.image}" class="img-thumbnail" />
            		</figure>
            		<!-- END: image -->
    		</div>
            <div class="col-xs-24 col-sm-24 col-md-12">
                <table class="table table-bordered">
                    ...
                    <!-- END: teacherinfo -->
                    <tr>
                        <td>{LANG.numlession}</td>
                        <td>{DETAIL.numlession} {LANG.cd}&nbsp;-&nbsp;{LANG.price} {DETAIL.price_show}</td>
                    </tr>
                    <tr>
                        <td>{LANG.timestudy}</td>
                        <td>{DETAIL.timestudy}</td>
                    </tr>
                    <tr>
                        <td>{LANG.timeend}</td>
                ...
                <div class="text-center">
                    ...
                    <!-- END: muakhoahoc -->
                    <!-- BEGIN: damuakhoahoc -->
                    <p class="well">{LANG.damuacakhoahoc_info}</p>
                    <!-- END: damuakhoahoc -->
            ...
            <div class="section">
               ...
               <ul class="learn-outline-list">
                  ...
                  <li class="learn-outline-item learn-lesson-wr">
                     <a class="scorm-right-link-wr" href="{BAIHOC.linkbaigiang}" title="{BAIHOC.title}">
