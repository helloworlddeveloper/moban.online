...
<div class="block_download">
    ...
    <div class="panel panel-default download">
        ...
        <div class="panel-body">
            <!-- BEGIN: row -->
            <em class="fa fa-link">&nbsp;</em>&nbsp;<a id="myfile{FILEUPLOAD.key}" href="{FILEUPLOAD.link}" onclick="nv_download_file('idown','{FILEUPLOAD.title}');return false;">{FILEUPLOAD.filename}</a>
            <!-- END: row -->
        </div>
    </div>
    <!-- END: fileupload -->
