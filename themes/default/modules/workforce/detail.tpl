								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<!-- BEGIN: adminfunction -->
											<a href="{ITIVIEWID.link_edit}#tab_customer" data-toggle="tooltip" data-original-title="{LANG.edit}"><i class="fa fa-edit fa-lg">&nbsp;</i></a> - <a href="{ITIVIEWID.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);" data-toggle="tooltip" data-original-title="{LANG.delete}"><em class="fa fa-trash-o fa-lg">&nbsp;</em></a>
											<!-- END: adminfunction -->
										</td>
									</tr>
									<!-- END: loop -->
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td class="text-center">
											<!-- BEGIN: adminfunction -->
												<a href="{COMMODITY.link_edit}#tab_commodity" data-toggle="tooltip" data-original-title="{LANG.edit}"><i class="fa fa-edit fa-lg">&nbsp;</i></a> - <a href="{COMMODITY.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);" data-toggle="tooltip" data-original-title="{LANG.delete}"><em class="fa fa-trash-o fa-lg">&nbsp;</em></a>
											<!-- END: adminfunction -->
											</td>
										</tr>
										<!-- END: loop -->
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td class="text-center">
												<!-- BEGIN: adminfunction -->
												<a href="{COST.link_edit}#tab_cost" data-toggle="tooltip" data-original-title="{LANG.edit}"><i class="fa fa-edit fa-lg">&nbsp;</i></a> - <a href="{COST.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);" data-toggle="tooltip" data-original-title="{LANG.delete}"><em class="fa fa-trash-o fa-lg">&nbsp;</em></a>
												<!-- END: adminfunction -->
											</td>
										</tr>
										<!-- END: loop -->
