<!-- BEGIN: main -->
<!-- BEGIN: data -->
<div class="text-center"><a href="{add_more}" class="btn btn-success">{LANG.add_unit_name}</a><br><br></div>
<table class="table table-striped table-bordered table-hover">
	<thead>
	<tr>
		<td><strong>{LANG.unit_name}</strong></td>
...
<form  action="" method="post">
	...
	<div class="form-group">
		<div class="input-group">
			...
			<input type="text" maxlength="60" value="{DATA.title}" name="title" class="form-control required" placeholder="{LANG.unit_name}" />
		</div>
	</div>
	<div class="form-group">
		<div class="input-group">
