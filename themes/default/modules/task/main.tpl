        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr class="percent">
                    <td colspan="9">
                        <!-- BEGIN: percent -->
                        <div style="background-color: blue; height: 4px; width: {VIEW.percent}px"></div> <!-- END: percent --> <!-- BEGIN: nonepercent -->
                        <div style="background-color: red; height: 4px; width: {VIEW.percent}px"></div> <!-- END: nonepercent -->
                    </td>
                </tr>
                <!-- END: loop -->
            </tbody>
