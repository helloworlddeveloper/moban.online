        ...
        <div class="row">
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-control datepicker" value="{SEARCH.starttime}" type="text" name="starttime" placeholder="{LANG.starttime}" /> <span class="input-group-btn">
            ...
            <div class="col-xs-24 col-md-4">
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-control datepicker" value="{SEARCH.endtime}" type="text" name="endtime" placeholder="{LANG.endtime}" /> <span class="input-group-btn">
								<button class="btn btn-default" type="button">
									<em class="fa fa-calendar fa-fix">&nbsp;</em>
								</button>
							</span>
...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        <caption>{LANG.transaction_list}</caption>
        <thead>
        <tr>
