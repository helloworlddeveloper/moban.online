...
<div id="print">
	<header id="header" class="row">
		<div style="width: 100%">
			...
			<div class="menu">
				<div class="header-name">CÔNG TY CỔ PHẦN PHÁT TRIỂN CÔNG NGHỆ GM WHITE</div>
				<div class="title-name">PHIẾU XUẤT KHO</div>
			</div>
		</div>
	</header>
		...
		<div class="clearfix">
			...
			<table class="table" style="width: 100%;text-align: center;font-weight: bold;">
				...
				<tr>
					...
					<td style="padding-top: 60px;border:none"></td>
					<td style="padding-top: 60px;border:none">Phạm Thị Huyền</td>
					<td style="padding-top: 60px;border:none"></td>
					<td style="padding-top: 60px;border:none">Phạm Thị Huyền</td>
				</tr>
			</table>
