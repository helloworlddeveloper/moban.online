			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="tab_customer">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<!-- BEGIN: adminfunction -->
											<a class="tab_customer" href="{ITIVIEWID.link_edit}" data-toggle="tooltip" data-original-title="{LANG.edit}"><i class="fa fa-edit fa-lg">&nbsp;</i></a> - <a href="{ITIVIEWID.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);" data-toggle="tooltip" data-original-title="{LANG.delete}"><em class="fa fa-trash-o fa-lg">&nbsp;</em></a>
											<!-- END: adminfunction -->
										</td>
									</tr>
									<!-- END: loop -->
					...
					<form class="form-horizontal" action="#" method="post">
						<div class="panel panel-default">
							<div class="panel-body">
								<input type="hidden" name="id" value="{ITI.id}" />
								<div class="form-group">
									<div class="col-sm-24 col-md-12">
								...
								<div class="form-group">
									<div class="col-sm-24 col-md-12">
										<label class="control-label"><strong>{LANG.qty_customer}</strong></label><input class="form-control" placeholder="{LANG.qty_customer_note}" type="text" name="qty_customer" value="{CUSTOMER.qty_customer}" pattern="^[0-9]*$" oninvalid="setCustomValidity( nv_digits )" oninput="setCustomValidity('')" />
									</div>
									<div class="col-sm-24 col-md-12">
					...
					<form class="form-horizontal" action="#" method="post">
						<div class="panel panel-default">
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td class="text-center">
											<!-- BEGIN: adminfunction -->
												<a class="tab_commodity" href="{COMMODITY.link_edit}" data-toggle="tooltip" data-original-title="{LANG.edit}"><i class="fa fa-edit fa-lg">&nbsp;</i></a> - <a href="{COMMODITY.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);" data-toggle="tooltip" data-original-title="{LANG.delete}"><em class="fa fa-trash-o fa-lg">&nbsp;</em></a>
											<!-- END: adminfunction -->
											</td>
										</tr>
										<!-- END: loop -->
							...
							<div class="panel-body">
								...
								<div class="form-group text-center">
									<input class="form-control" type="hidden" name="id" value="{COMMODITY_EDIT.id}" />
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td class="text-center">
												<!-- BEGIN: adminfunction -->
												<a class="tab_cost" href="{COST.link_edit}" data-toggle="tooltip" data-original-title="{LANG.edit}"><i class="fa fa-edit fa-lg">&nbsp;</i></a> - <a href="{COST.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);" data-toggle="tooltip" data-original-title="{LANG.delete}"><em class="fa fa-trash-o fa-lg">&nbsp;</em></a>
												<!-- END: adminfunction -->
											</td>
										</tr>
										<!-- END: loop -->
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<div class="col-sm-24 col-md-24">
										...
										<input class="form-control" type="text" name="localtion_cost" value="{COST_EDIT.localtion_cost}"/>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-24 col-md-24">
								...
								<div class="form-group text-center">
									<input class="form-control" type="hidden" name="id" value="{COST_EDIT.id}" />
...
<script type="text/javascript">
	$('.tab_customer').attr('href', $('.tab_customer').attr('href') + '#tab_customer')
    $('.tab_commodity').attr('href', $('.tab_commodity').attr('href') + '#tab_commodity')
    $('.tab_cost').attr('href', $('.tab_cost').attr('href') + '#tab_cost')
	//<![CDATA[
    $(function(){
