        ...
        <div class="cont">
            <div class="cont2">
                <div class="fl">
                    ...
                    <!-- BEGIN: download -->
                    <a class="download" href="{DETAILCONTENT.download_video}"><img src="{NV_BASE_SITEURL}{NV_ASSETS_DIR}/images/download.png" alt="" width="15" height="15" /><span>{LANG.download}</span></a>
                    <!-- END: download -->
