...
<div  class="ss1-hotro myform">
    <div class="myform2">
        <h3>FORM NHẬP THÔNG TIN KHÁCH MỜI THAM GIA HỘI THẢO CỦA NPP</h3>
        <p>Vui lòng điền thông tin đăng ký của bạn vào bên dưới.</p>
...
<script type="text/javascript">
    $('input[name=reg_submit]').click(function() {
        ...
        if( fullname == '' ){
            ...
            $.ajax({
    			type : "POST",
    			url : nv_base_siteurl + "index.php?" + nv_name_variable + "={MODULE_NAME}&" + nv_fc_variable + "=hoi-thao&nocache=" + new Date().getTime(),
