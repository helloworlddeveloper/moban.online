		...
		<table class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					...
					<th>{LANG.content}</th>
					<th class="w150 text-center">{LANG.totalsmssend}</th>
					<th width="170" class="text-center">{LANG.totalsmssuccess}</th>
			...
			<tbody>
				...
				<tr>
					...
					<td>{VIEW.content}</td>
					<td class="text-center">{VIEW.totalsmssend}</td>
					<td class="text-center">{VIEW.totalsmssuccess}</td>
					<td>{VIEW.addtime}</td>
