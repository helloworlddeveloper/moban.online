...
<div class="panel panel-default">
	<div class="panel-body">
		<ul class="nav nav-tabs" role="tablist">
			...
			<li role="presentation" <!-- BEGIN: excel_disabled -->class="disabled"<!-- END: excel_disabled -->><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">{LANG.customer_import}</a></li>
		</ul>
			...
			<div role="tabpanel" class="tab-pane" id="tab2">
				<div class="well">
					<form action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" id="frm-import" method="post" enctype="multipart/form-data">
						<div class="row">
							...
							<div class="col-xs-20">
								<button type="submit" class="btn btn-primary btn-sm" name="read" id="btn-read" disabled="disabled"><em class="fa fa-check">&nbsp;</em>{LANG.readdata}</button>
								<a href="{TEMPLATE_URL}" target="_blank" class="btn btn-primary btn-sm"><em class="fa fa-download">&nbsp;</em>{LANG.downloadexcel}</a>
							</div>
						</div>
					</form>
				</div>
				...
				<form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
					...
					<div class="text-center">
						<input id="btn-import" type="submit" name="import" class="btn btn-primary" <!-- BEGIN: error_btn -->disabled="disabled"<!-- END: error_btn --> value="" />
					</div>
				</form>
