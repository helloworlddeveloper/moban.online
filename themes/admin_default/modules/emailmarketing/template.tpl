	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-6">
			<div class="form-group">
				...
				<a href="{URLADD}" class="btn btn-success">{LANG.template_add}</a>
			</div>
		</div>
	</div>
</form>
...
<script>
	function nv_change_status(id) {
		...
		if (confirm(nv_is_change_act_confirm[0])) {
			...
			$.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=template&nocache=' + new Date().getTime(), 'change_status=1&id=' + id, function(res) {
