	...
	<form action="{NV_BASE_ADMINURL}index.php" method="post" class="form-horizontal">
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				<tbody>
					<tr>
						<td class="w150">{LANG.album_add_title} : </td>
					...
					<tr>
						<td>{LANG.album_inhome} : </td>
						<td><label><input name="status" type="checkbox" value="1" checked="{checked}" />{LANG.album_yes}</label></td>
					</tr>
					<tr>
						<td class="text-center" colspan="2"><input class="btn btn-primary" name="submit" style="width:80px;margin-left:110px" type="submit" value="{LANG.album_submit}" /></td>
					</tr>
				</tbody>
			</table>
		</div>
