			...
			<tbody>
				...
				<tr class="{ROW.class}">
					...
					<td class="text-center">
						<i class="fa fa-address-book-o fa-lg">&nbsp;</i><a href="{ROW.link_diary}">{LANG.listdiary}</a> - <i class="fa fa-edit fa-lg">&nbsp;</i><a href="{ROW.link_edit}">{LANG.edit}</a> - <em class="fa fa-trash-o fa-lg">&nbsp;</em><a href="{ROW.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);">{LANG.delete}</a>
                    </td>
				</tr>
				<!-- END: loop -->
			</tbody>
