	...
	<div class="table-responsive">
		<table class="table table-striped table-bordered table-hover">
			<tbody>
				...
				<tr>
					<td> {LANG.jobs} </td>
					<td><input class="form-control" type="text" name="jobs" value="{ROW.jobs}" /></td>
				</tr>
				<tr>
					<td> {LANG.link} </td>
				...
				<tr>
					...
					<td>
						<select name="catid" class="form-control w300">
							<!-- BEGIN: catid -->
							<option value="{LISTCATS.id}"{LISTCATS.sl}>{LISTCATS.title}</option>
							<!-- END: catid -->
						</select>
					</td>
				</tr>
				<tr>
					<td> {LANG.bodytext} </td>
					<td>
						<textarea cols="40" rows="5" class="form-control" name="bodytext">{ROW.bodytext}</textarea>
					</td>
				</tr>
				<tr>
					<td> {LANG.status} </td>
