...
<form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
	...
	<div class="row">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div id="priceproduct">
							...
							<div class="form-group">
								<label class="col-md-4 control-label">{LANG.product_price_sale}</label>
								<div class="col-md-8">
									<input class="form-control" type="text" maxlength="50" value="{rowcontent.product_price_sale}" name="product_price_sale" onkeyup="this.value=FormatNumber(this.value);"/>
								</div>
							</div>
		...
		<div class="col-sm-24 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">{LANG.content_cat}</div>
				<div class="panel-body">
						<div class="message_body" style="height:260px; overflow: auto">
							<table class="table table-striped table-bordered table-hover">
								...
								<!-- BEGIN: rowscat -->
								<tr>
									<td><label><input style="margin-left: {CATS.space}px;" type="checkbox" value="{CATS.catid}" name="catids[]" class="news_checkbox" {CATS.checked} {CATS.disabled}> {CATS.title} </label></td>
