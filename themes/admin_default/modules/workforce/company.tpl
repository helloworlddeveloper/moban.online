...
<table class="table table-striped table-bordered table-hover">
	<thead>
		<tr>
			...
			<td><strong>{LANG.company_name_note}</strong></td>
...
<form class="form-inline" action="" method="post">
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			<td align="right" width="150px"><strong>{LANG.company_name}: </strong></td>
			<td><input class="form-control" style="width: 600px" name="title" type="text" value="{DATA.title}" maxlength="255" /></td>
		</tr>
		<tr>
			<td valign="top" align="right"><strong>{LANG.company_name_note}: </strong></td>
