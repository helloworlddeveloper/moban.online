...
<form class="form-inline" action="{NV_BASE_ADMINURL}index.php" method="get">
    ...
    <table class="table table-striped table-bordered table-hover">
		<tbody>
			<tr>
                <td>
                    <select style="width: 100%;" class="form-control" name="customertype">
                        <option value="-1">{LANG.customertype_search}</option>
                        <!-- BEGIN: customertype_select -->
                        <option value="{OPTION.key}" {OPTION.selected}>{OPTION.title}</option>
                        <!-- END: customertype_select -->
                    </select>
                </td>
                <td>
