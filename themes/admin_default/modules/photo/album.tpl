...
<div id="content"> 
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form action="" method="post" class="form-inline" id="form-album">
				<div class="table-responsive">
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								<td class="text-center" ><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);"></td>
								<td class="text-left"><a href="{URL_NAME}">{LANG.album_name}</a> </td>
								<td class="text-center"> <strong>{LANG.album_category} </strong></td>
								<td class="text-center"> <strong>{LANG.album_num_photo} </strong></td>
								<td class="text-center"> <strong>{LANG.album_status} </strong></td>
								<td class="text-center"> <strong>{LANG.album_date_added} </strong></td>
								<td class="text-center" ><a href="{URL_WEIGHT}">{LANG.weight}</a></td>
			...
			<div class="row">
				...
				<div style="clear:both"></div>{GENERATE_PAGE}</div>
			</div>
			<!-- END: generate_page -->
		</div>
