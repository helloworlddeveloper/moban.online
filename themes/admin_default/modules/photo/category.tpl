...
<div id="content"> 
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="#" method="post" enctype="multipart/form-data" id="form-category" class="form-inline">
				<div class="table-responsive">
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								<td class="text-center" style="width:80px" ><a href="{URL_WEIGHT}">{LANG.weight}</a></td>
								<td class="text-left"><a href="{URL_NAME}">{LANG.category_name}</a> </td>
								<td class="text-center"> <strong>{LANG.category_inhome} </strong></td>
								<td class="text-center"> <strong>{LANG.category_viewcat} </strong></td>
								<td class="text-center"> <strong>{LANG.category_numlinks} </strong></td>
