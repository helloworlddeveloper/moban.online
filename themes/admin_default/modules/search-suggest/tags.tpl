...
<div class="well">
	<form class="navbar-form" action="{NV_BASE_ADMINURL}index.php" method="get" onsubmit="return nv_search_tag();">
        ...
        <input class="btn btn-primary" name="get_keyword" type="button" value="{LANG.get_keyword}" /><br /><br />
...
$(document).ready(function(){
    ...
    $('input[name=get_keyword]').click(function(){
        $.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '={OP}&nocache=' + new Date().getTime(), 'get_keyword=1', function(res) {
