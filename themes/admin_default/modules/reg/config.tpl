...
<form action="" method="post" class="form-horizontal">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label"><strong>{LANG.list_phone}</strong></label>
                <div class="col-sm-20">
                    <input type="text" class="form-control" value="{DATA.list_phone}" name="list_phone" />
                    <i>{LANG.list_phone_note}</i>
                </div>
            </div>
            <div class="form-group">
