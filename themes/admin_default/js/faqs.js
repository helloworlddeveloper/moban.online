...
function nv_de_del( id )
{
   ...
   { 
     window.location.href = script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=main&del=1&id=' + id;
   }
   return false;
}
...
0!=b?(nv_ajax("post",script_name,nv_name_variable+"="+nv_module_name+"&op=add&action=1&provinceid="+b,"thu","")):($("#thu").hide())}