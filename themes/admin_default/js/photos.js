...
function nv_delete_image(rowid) {
    if (confirm(nv_is_del_confirm[0])) {
        $.ajax({
            url: script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=view&action=delete&nocache=' + new Date().getTime(),
            type: 'post',
            dataType: 'json',
            data: 'rowid=' + rowid,
            success: function(json) {
...
function nv_show_image(rowid) {
    if (confirm(nv_is_change_act_confirm[0])) {
        $.ajax({
            url: script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=view&action=show&nocache=' + new Date().getTime(),
            type: 'post',
            dataType: 'json',
            data: 'rowid=' + rowid,
            success: function(json) {
