...
<div class="news_column panel panel-default">
	<div class="panel-body">
        ...
        <!-- BEGIN: popup -->
        <a id="button-download-popup" class="btn btn-danger"><em class="fa fa-link">&nbsp;</em>&nbsp;{LANG.download_fileaddtack}</a>
        {FILE "popup_content.tpl"}
        <!-- END: popup -->
		<!-- BEGIN: files -->
...
<div class="news_column panel panel-default">
	<div class="panel-body">
	{CONTENT_COMMENT}
    <div><div class="fb-comments" data-href="{SELFURL}" data-width="100%" data-numposts="5"></div></div>
    </div>
</div>
<!-- END: comment -->
