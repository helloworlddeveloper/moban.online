	...
	<form action="" method="post" name="fpost" id="fpost" class="form-horizontal">
		...
		<div class="panel panel-default">
		    <div class="panel-body">
				<!-- BEGIN: agency_chossen -->
				<div class="form-group">
					<label class="col-sm-6 control-label">
						{LANG.agency_name}
						<em class="fa fa-question-circle fa-pointer text-info" data-toggle="tooltip" data-original-title="Lưu ý: Mã này cần tương đồng với mã nhân viên trên máy chấm công!">&nbsp;</em>
					</label>
					<div class="col-sm-18">
						<div class="uiTokenizer uiInlineTokenizer"  style="float:left;">
	                            <span id="userid" class="tokenarea">
                                    ...
                                    <span class="uiToken removable" title="{DATA.fullname}">
                                        {DATA.order_name}<input type="hidden" autocomplete="off" name="who_is" value="{DATA.who_is}" />
				...
				<script type="text/javascript">
                    ...
                    function nv_add_element( data ){
                        var html = "<span title=\"" + data.value + "\" class=\"uiToken removable\">" + data.fullname + "<input type=\"hidden\" value=\"" + data.key + "\" name=\"who_is\" autocomplete=\"off\"><a onclick=\"$(this).parent().remove();\" href=\"javascript:void(0);\" class=\"remove uiCloseButton uiCloseButtonSmall\"></a></span>";
                        $("#userid").html( html );
                        $('#order_name').val(data.fullname);
                        $('#order_phone').val(data.mobile);
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-18">
                        <p class="form-control-static"><input type="email" name="order_email" id="order_email" value="{DATA.order_email}" class="form-control" /></p>
		...
		<div class="clear"></div>
		<!-- END: total_coupons -->
		<span class="error">{ERROR.chossen_agency_error_price}<br></span>
