...
<div id="detail">
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="row">
				<div class="col-xs-24 col-sm-6 col-md-12 text-center">
					...
					<ul class="product_info">
						...
						<li>
							<p>
								<!-- BEGIN: discounts -->
                                {LANG.pro_price}:
								<span class="discounts_money product_price_details">{PRICE.price_format} {PRICE.unit}</span>
								<span class="money">{product_discounts} {money_unit}</span><br />
                                {LANG.detail_pro_price}:
                                <span class="money product_price_details_sale">{PRICE.sale_format} {PRICE.unit}</span>
                                <span class="price_discount">-{PRICE.discount_percent} {PRICE.discount_unit}</span>
						...
						<!-- END: group_detail -->
                        <!-- BEGIN: discounts_time -->
                        <li class="clearfix">
                            <div class="product_stats border-top">
                               <div class="product_purchases col-sm-12 col-md-12">
                                  <i class="fa fa-info-circle" aria-hidden="true">&nbsp;</i> &nbsp;{LANG.product_ok}
                               </div>
                               <div class="product_availability col-sm-12 col-md-12">
