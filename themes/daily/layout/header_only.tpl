<!DOCTYPE html>
	...
	<head>
		...
		<!-- END: js -->
<!-- ManyChat -->
<script src="//widget.manychat.com/1058921834258529.js" async="async">
</script>
        <!-- Facebook Pixel Code -->
        <script>
        ...
        <!-- Google Code for daily.gmwhite.com.vn Conversion Page -->
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-121306190-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-121306190-2');
</script>
