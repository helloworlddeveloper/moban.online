...
if (! nv_function_exists('nv_block_sanpham_gmwhite')) {
    function nv_block_sanpham_gmwhite_config( $module, $data_block, $lang_block)
    {
        global $lang_global;
    ...
    function nv_block_sanpham_gmwhite_config_submit()
    {
        global $nv_Request;
    ...
    /**
     * nv_block_sanpham_gmwhite()
     *
     * @param mixed $block_config
     * @return
     */
    function nv_block_sanpham_gmwhite($block_config)
    {
        global $global_config, $lang_global, $blockID;

        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.block_sanpham_gmwhite.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.block_sanpham_gmwhite.tpl')) {
       ...
       // print_r($block_config);die;
        ...
        $xtpl = new XTemplate('global.block_sanpham_gmwhite.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_sanpham_gmwhite($block_config);
}
