...
if (! nv_function_exists('nv_block_mypham_gmwhite_quyenloi')) {
    function nv_block_mypham_gmwhite_quyenloi_config( $module, $data_block, $lang_block)
    {
        global $lang_global;
    ...
    function nv_block_mypham_gmwhite_quyenloi_config_submit()
    {
        global $nv_Request;
     ...
     * @return
     */
    function nv_block_mypham_gmwhite_quyenloi($block_config)
    {
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_mypham_gmwhite_quyenloi($block_config);
}
