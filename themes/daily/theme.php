...
function nv_site_theme($contents, $full = true)
{
    ...
    $html_links[] = array(
        'rel' => 'StyleSheet',
        'href' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/css/update.css'
    );
    $html_links[] = array(
        'rel' => 'StyleSheet',
    ...
    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/js/owl.carousel.min.js'
    );
    $html_js[] = array(
        'ext' => 1,
        'content' => NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/js/bootstrap.min.js'
    );
