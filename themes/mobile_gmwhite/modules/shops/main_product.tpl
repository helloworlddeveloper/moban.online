            ...
            <div class="floadright product-item">
                ...
                <div class="col-md-24">
                    ...
                    <strong class="best_price">
                        <!-- BEGIN: discounts -->
                        <span class="discounts_money">{PRICE.sale_format} {PRICE.unit}</span>
                ...
                <div style="padding-top: 15px" class="col-md-12 col-sm-12 col-xs-14">
                    <!-- BEGIN: product_code -->
                    <p><strong>{LANG.product_code}:</strong> <span class="best_msp_space"></span>{PRODUCT_CODE}</p>
                    <!-- END: product_code -->
                </div>
                <div style="padding-top: 15px" class="col-md-12 col-sm-12 col-xs-10">
                    <!-- BEGIN: order -->
