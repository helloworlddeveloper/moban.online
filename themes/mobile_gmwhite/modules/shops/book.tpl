...
<div class="step_bar alert alert-success clearfix">
    <a class="step step_current" title="{LANG.chossen_agency}" href="#"><span>1</span>{LANG.chossen_agency}</a>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>{PRODUCT.price_agency.sale_format}</td>
                <td><a href="javascript:void(0)" id="{PRODUCT.id}" title="{PRODUCT.title}" onclick="cartorderAgency(this, 0, '{PRODUCT.link}')"><button type="button" class="btn btn-primary btn-xs">{LANG.add_product}</button></a></td>
            </tr>
            <!-- END: loop -->
            </tbody>
        </table>
